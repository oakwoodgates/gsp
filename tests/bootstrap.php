 ...
 * @since 1.0.0
 */
function _manually_load_gsp_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/gsp.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_gsp_plugin' );
